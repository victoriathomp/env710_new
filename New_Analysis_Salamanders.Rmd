...
salamanders_alldata_filtered_minusR <- salamanders_alldata_filtered_minusR %>%
  mutate(body_condition = WEIGHT / VENT_LENGTH)

sala.FINALMODEL1.2 <- lme(body_condition ~ REACH_TYPE + log(number_of_wood_pieces), random =~1 | SITE, data = salamanders_alldata_filtered_minusR)

summary(sala.FINALMODEL1.2)
plot(sala.FINALMODEL1.2)
...
sala.FINALMODEL2.2 <- lme(body_condition ~ REACH_TYPE + average_canopy_cover, random =~1 | SITE, data = salamanders_alldata_filtered_minusR)

summary(sala.FINALMODEL2.2)
plot(sala.FINALMODEL2.2)
...
sala.FINALMODEL3.2 <- lme(body_condition ~ REACH_TYPE + average_maximum_depth, random =~1 | SITE, data = salamanders_alldata_filtered_minusR)

summary(sala.FINALMODEL3.2)
plot(sala.FINALMODEL3.2)
...
AIC (sala.FINALMODEL2.2)
AIC(sala.FINALMODEL3.2)
AIC(sala.FINALMODEL1.2)
```
